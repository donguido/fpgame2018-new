...
inputKeyGame (EventKey (Char 'p') Down _ _) gstate
 = GamePaused ShowPause (elapsedTime gstate) (upVector gstate) (rightVector gstate) (leftVector gstate) (rightUpVector gstate) (leftUpVector gstate) (score gstate) (lives gstate)
inputKeyGame _ gstate = gstate
 
inputKeyMenu :: Event -> GameState -> GameState
inputKeyMenu (EventKey (SpecialKey KeyEnter) _ _ _) gstate
 = GamePlaying ShowGame 0 0 0 0 0 0 0 3
...
inputKeyPaused (EventKey (Char 'p') Down _ _) gstate
 = GamePlaying ShowGame (elapsedTime gstate) (upVector gstate) (rightVector gstate) (leftVector gstate) (rightUpVector gstate) (leftUpVector gstate) (score gstate) (lives gstate)
...
zeroLives gstate = case gstate of
  GamePlaying _ _ _ _ _ _ _ _ _ -> case lives gstate of 
